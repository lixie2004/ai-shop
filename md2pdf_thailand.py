#!/usr/bin/env python3
"""Convert Thailand formal project report from Markdown to PDF via weasyprint."""

import markdown_it
import weasyprint
import os

INPUT_MD = "/home/nicli/.openclaw/workspace/reports/thailand-formal-project-report-2026-05-25.md"
OUTPUT_PDF = "/home/nicli/.openclaw/workspace/reports/thailand-formal-project-report-2026-05-25.pdf"
...
@page {{
    ...
    @bottom-center {{
        content: "泰国选品分析正式报告 | 机密文件 | 第 " counter(page) " 页";
