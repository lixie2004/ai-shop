#!/usr/bin/env python3
"""Convert Malaysia formal project report from Markdown to PDF via weasyprint."""

import markdown_it
import weasyprint
import os

INPUT_MD = "/home/nicli/.openclaw/workspace/reports/malaysia-formal-project-report-2026-05-24.md"
OUTPUT_PDF = "/home/nicli/.openclaw/workspace/reports/malaysia-formal-project-report-2026-05-24.pdf"
...
@page {{
    ...
    @bottom-center {{
        content: "马来西亚选品分析正式报告 | 机密文件 | 第 " counter(page) " 页";
        font-family: 'Noto Sans CJK SC', 'Noto Sans SC', 'WenQuanYi Micro Hei', sans-serif;
        font-size: 8pt;
        color: #9ca3af;
    }}
